...
const getPlayerWinPercentageByAverageOfWins = async () => {
    let data = null;
    try {
...
const getPlayerWinPercentage = async () => {
    let data = null;
    try {
...
export { getPlayerByCountry, addMatch, getPlayerWinPercentageByAverageOfWins, getPlayerWinPercentage};